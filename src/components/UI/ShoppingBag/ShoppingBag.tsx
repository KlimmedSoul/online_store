...
const ShoppingBag: React.FC<Props> = ({ggg}) => { 
    const count = ggg.length; 
    ...
    return (
        <div className={cl.root}>
            <div className={cl.header}>
                ...
                <p className={cl.all_count}>{count}</p>
            </div>

            <div className={cl.products_handler}>
                {products.map(prod => (
                    <div className={cl.prod_card} key={prod.id}>

                        <div className={cl.ico_handler}>
                            <img src={prod.img} alt="123" className={cl.prod_ico}/>
                        </div>
                        ...
                        <div className={cl.info_handler} >
                            ...
                            <div className={cl.info_title_handler}>
                                ...
                                <p className={cl.art}>Арт {prod.art}</p>
                            </div>
                            ...
                            <div className={cl.favorite_and_remove}>
                                <div className={cl.far_handler}>
                                    ...
                                    <p className={cl.title_btns}>В избранное</p>
                                </div>
                                ...
                                <div className={cl.far_handler}>
                                    ...
                                    <p className={cl.title_btns}>Удалить</p>
                                </div>
                            </div>
                        ...
                        <div className={cl.cost_handler}>
                            ...
                            <h1 className={cl.cost}>{prod.cost}</h1>
            ...
            <div className={cl.order_handler}>
                <div className={cl.total_handler}>
                    <h1 className={cl.total_title}>Итого: <span className={cl.total}>{total}</span></h1>
                    <p className={cl.all_prod_count}>Товары, {count} шт.</p>
                </div>

                <div className={cl.button}>
                    <p className={cl.button_title}>Заказать</p>
                </div>

                <div className={cl.checkbox_handler}>
                    <input type="checkbox" className={cl.checkbox}/>
                    <p className={cl.checkbox_text}>Согласен с условиями правил пользования торговой площадкой и правилами возврата</p>
                </div>
